...
from mypy.nodes import (ArgKind, ClassDef, Decorator, FuncBase, FuncDef,
                        FuncItem, LambdaExpr, OverloadedFuncDef, TypeInfo, Var)
...
from mypyc.ir.func_ir import (FUNC_CLASSMETHOD, FUNC_NORMAL, FUNC_STATICMETHOD,
                              FuncDecl, FuncIR, FuncSignature, RuntimeArg)
from mypyc.ir.ops import (BasicBlock, GetAttr, Integer, LoadAddress,
                          LoadLiteral, Register, Return, SetAttr, Unbox,
                          Unreachable, Value)
from mypyc.ir.rtypes import (RInstance, bool_rprimitive, dict_rprimitive,
                             int_rprimitive, object_rprimitive)
from mypyc.irbuild.builder import (IRBuilder, calculate_arg_defaults,
                                   gen_arg_defaults)
from mypyc.irbuild.callable_class import (add_call_to_callable_class,
                                          add_get_to_callable_class,
                                          instantiate_callable_class,
                                          setup_callable_class)
from mypyc.irbuild.context import FuncInfo
from mypyc.irbuild.env_class import (add_vars_to_env, finalize_env_class,
                                     load_env_registers, setup_env_class)
from mypyc.irbuild.generator import gen_generator_func, gen_generator_func_body
from mypyc.irbuild.targets import AssignmentTarget
from mypyc.primitives.dict_ops import (dict_get_method_with_none, dict_new_op,
                                       dict_set_item_op)
