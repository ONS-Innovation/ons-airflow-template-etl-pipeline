...
from mypy.nodes import (EXCLUDED_ENUM_ATTRIBUTES, TYPE_VAR_TUPLE_KIND,
                        AssignmentStmt, CallExpr, ClassDef, Decorator,
                        EllipsisExpr, ExpressionStmt, FuncDef, Lvalue,
                        MemberExpr, NameExpr, OverloadedFuncDef, PassStmt,
                        RefExpr, StrExpr, TempNode, TypeInfo, TypeParam,
                        is_class_var)
from mypy.types import Instance, UnboundType, get_proper_type
from mypyc.common import PROPSET_PREFIX
from mypyc.ir.class_ir import ClassIR, NonExtClassInfo
from mypyc.ir.func_ir import FuncDecl, FuncSignature
from mypyc.ir.ops import (NAMESPACE_TYPE, BasicBlock, Branch, Call, InitStatic,
                          LoadAddress, LoadErrorValue, LoadStatic, MethodCall,
                          Register, Return, SetAttr, TupleSet, Value)
from mypyc.ir.rtypes import (RType, bool_rprimitive, dict_rprimitive,
...
from mypyc.irbuild.function import (gen_property_getter_ir,
                                    gen_property_setter_ir, handle_ext_method,
                                    handle_non_ext_method, load_type)
from mypyc.irbuild.util import (dataclass_type, get_func_def, is_constant,
                                is_dataclass_decorator)
from mypyc.primitives.dict_ops import dict_new_op, dict_set_item_op
from mypyc.primitives.generic_ops import (iter_op, next_op, py_get_item_op,
                                          py_hasattr_op, py_setattr_op)
from mypyc.primitives.misc_ops import (dataclass_sleight_of_hand, import_op,
                                       not_implemented_op, py_calc_meta_op,
                                       pytype_from_template_op, type_object_op)
