...
from mypyc.primitives.dict_ops import (dict_copy, dict_del_item,
                                       mapping_has_key,
                                       supports_mapping_protocol)
from mypyc.primitives.generic_ops import generic_ssize_t_len_op
from mypyc.primitives.list_ops import (sequence_get_item, sequence_get_slice,
...
class MatchVisitor(TraverserVisitor):
    ...
    def visit_mapping_pattern(self, pattern: MappingPattern) -> None:
        ...
        if pattern.rest:
            ...
            rest = self.builder.primitive_op(
                dict_copy, [self.subject], pattern.rest.line
            )
