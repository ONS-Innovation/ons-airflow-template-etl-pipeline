...
from mypyc.common import (ATTR_PREFIX, BITMAP_BITS,
                          FAST_ISINSTANCE_MAX_SUBCLASSES, HAVE_IMMORTAL,
                          NATIVE_PREFIX, REG_PREFIX, STATIC_PREFIX,
                          TYPE_PREFIX)
from mypyc.ir.class_ir import ClassIR, all_concrete_classes
from mypyc.ir.func_ir import FuncDecl
from mypyc.ir.ops import BasicBlock, Value
from mypyc.ir.rtypes import (RInstance, RPrimitive, RTuple, RType, RUnion,
                             int_rprimitive, is_bit_rprimitive,
                             is_bool_rprimitive, is_bytes_rprimitive,
                             is_dict_rprimitive, is_fixed_width_rtype,
                             is_float_rprimitive, is_frozenset_rprimitive,
                             is_int16_rprimitive, is_int32_rprimitive,
                             is_int64_rprimitive, is_int_rprimitive,
                             is_list_rprimitive, is_none_rprimitive,
                             is_object_rprimitive, is_optional_type,
                             is_range_rprimitive, is_set_rprimitive,
                             is_short_int_rprimitive, is_str_rprimitive,
                             is_tuple_rprimitive, is_uint8_rprimitive,
