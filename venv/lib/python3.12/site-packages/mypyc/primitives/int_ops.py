...
from mypyc.ir.ops import (ERR_ALWAYS, ERR_MAGIC, ERR_MAGIC_OVERLAPPING,
                          ERR_NEVER, PrimitiveDescription)
from mypyc.ir.rtypes import (RType, bit_rprimitive, bool_rprimitive,
...
from mypyc.primitives.registry import (binary_op, custom_op, function_op,
                                       load_address_op, unary_op)
...
int_eq = int_binary_primitive(
    op="==", primitive_name="int_eq", return_type=bit_rprimitive
)
int_ne = int_binary_primitive(
    op="!=", primitive_name="int_ne", return_type=bit_rprimitive
)
int_lt = int_binary_primitive(
    op="<", primitive_name="int_lt", return_type=bit_rprimitive
)
int_le = int_binary_primitive(
    op="<=", primitive_name="int_le", return_type=bit_rprimitive
)
int_gt = int_binary_primitive(
    op=">", primitive_name="int_gt", return_type=bit_rprimitive
)
int_ge = int_binary_primitive(
    op=">=", primitive_name="int_ge", return_type=bit_rprimitive
)
