...
from mypyc.test.testutil import (ICODE_GEN_BUILTINS, MypycDataSuite,
                                 assert_test_output, build_ir_for_single_file2,
                                 infer_ir_build_options_from_test_name,
                                 remove_comment_lines, use_custom_builtins)
...
class TestReport(MypycDataSuite):
    ...
    def run_case(self, testcase: DataDrivenTestCase) -> None:
        ...
        with use_custom_builtins(
            ...
            ir = None
            try:
                ir, tree, type_map, mapper = build_ir_for_single_file2(
                ...
                annotations = generate_annotations(
                    "native.py", tree, ir, type_map, mapper
                )
                actual = []
