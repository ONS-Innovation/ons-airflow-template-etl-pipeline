...
from mypyc.ir.rtypes import (RInstance, RTuple, RUnion, bool_rprimitive,
                             int_rprimitive, list_rprimitive, none_rprimitive,
...
class TestEmitter(unittest.TestCase):
    ...
    def test_object_annotation(self) -> None:
        assert (
            self.emitter.object_annotation("hello, world", "line;")
            == " /* 'hello, world' */"
        )
        assert (
