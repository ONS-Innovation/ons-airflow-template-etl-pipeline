...
from typing import (IO, TYPE_CHECKING, Any, BinaryIO, Generator, Literal,
                    Mapping, Sequence, TextIO, TypeVar, overload)
from urllib.parse import urlsplit

from fsspec.registry import get_filesystem_class
from fsspec.spec import AbstractFileSystem
from upath._compat import (FSSpecAccessorShim, PathlibPathShim,
                           method_and_classmethod, str_remove_prefix,
                           str_remove_suffix)
from upath._flavour import (LazyFlavourDescriptor, upath_get_kwargs_from_url,
                            upath_urijoin)
