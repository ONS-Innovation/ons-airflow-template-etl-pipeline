...
from mypy.nodes import (SYMBOL_FUNCBASE_TYPES, UNBOUND_IMPORTED, Decorator,
                        FuncDef, FuncItem, MypyFile, OverloadedFuncDef,
                        ParamSpecExpr, SymbolNode, SymbolTable, TypeAlias,
                        TypeInfo, TypeVarExpr, TypeVarTupleExpr, Var)
...
from mypy.types import (AnyType, CallableType, DeletedType, ErasedType,
                        ...
                        Parameters, ParamSpecType, PartialType, TupleType,
                        Type, TypeAliasType, TypedDictType, TypeType,
