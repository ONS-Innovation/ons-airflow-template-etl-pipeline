...
from typing import (TYPE_CHECKING, Any, Callable, ClassVar, Final, NamedTuple,
                    NoReturn, TextIO, TypedDict)

import mypy.semanal_main
from mypy.checker import TypeChecker
from mypy.error_formatter import OUTPUT_CHOICES, ErrorFormatter
from mypy.errors import CompileError, ErrorInfo, Errors, report_internal_error
from mypy.graph_utils import (prepare_sccs, strongly_connected_components,
                              topsort)
...
from mypy.util import (DecodeError, decode_python_encoding, get_mypy_comments,
                       hash_digest, is_stub_package_file, is_sub_path_normabs,
                       is_typeshed_file, module_prefix, read_py_file, time_ref,
                       time_spent_us)
...
from mypy.modulefinder import (FindModuleCache, ModuleNotFoundReason,
                               ModuleSearchResult, SearchPaths,
...
class State:
    ...
    def compute_fine_grained_deps(self) -> dict[str, set[str]]:
        ...
        if self.id in ("builtins", "typing", "types", "sys", "_typeshed"):
            ...
            return {}
        from mypy.server.deps import \
            get_dependencies  # Lazy import to speed up startup
