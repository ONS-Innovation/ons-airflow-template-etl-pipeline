...
from mypy.nodes import (ARG_POS, Context, Expression, NameExpr, TypeAlias,
                        TypeInfo, Var)
...
from mypy.typeops import (coerce_to_literal, make_simplified_union,
                          try_getting_str_literals_from_type, tuple_fallback)
from mypy.types import (AnyType, Instance, LiteralType, NoneType, ProperType,
                        TupleType, Type, TypedDictType, TypeOfAny,
                        TypeVarTupleType, TypeVarType, UninhabitedType,
                        UnionType, UnpackType, find_unpack_in_list,
