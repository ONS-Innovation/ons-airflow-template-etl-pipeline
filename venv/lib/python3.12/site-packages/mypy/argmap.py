...
from mypy.types import (AnyType, Instance, ParamSpecType, TupleType, Type,
                        TypedDictType, TypeOfAny, TypeVarTupleType, UnpackType,
                        get_proper_type)
    ...
    for ai, actual_kind in enumerate(actual_kinds):
        if actual_kind == nodes.ARG_POS:
            ...
            if (
                ...
                and formal_kinds[formal_names.index(name)] != nodes.ARG_STAR
            ):
