...
def render(
    model: Annotated[
        str,
        typer.Argument(
            metavar="<module>:<attribute>", help="Python path to the model to render"
        ),
    ],
    app: Annotated[
        str,
        typer.Option(
            metavar="<module>:<attribute>", help="Python path to the main Cadwyn app"
        ),
    ],
    version: Annotated[
        str,
        typer.Option(
            parser=lambda s: str(date.fromisoformat(s)), metavar="ISO-VERSION"
        ),
    ],
    raw: _RAW_ARG = False,
) -> None:
...
def render_module(
    module: Annotated[
        str,
        typer.Argument(metavar="<module>", help="Python path to the module to render"),
    ],
    app: Annotated[
        str,
        typer.Option(
