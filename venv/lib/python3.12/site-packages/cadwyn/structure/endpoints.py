...
def endpoint(
    path: str, methods: list[str], /, *, func_name: Union[str, None] = None
...
AlterEndpointSubInstruction = Union[
    EndpointDidntExistInstruction, EndpointExistedInstruction, EndpointHadInstruction
]
