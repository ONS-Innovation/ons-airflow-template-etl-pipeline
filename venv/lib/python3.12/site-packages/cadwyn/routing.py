...
class _RootCadwynAPIRouter(APIRouter):
    ...
    async def _get_routes_from_closest_suitable_version(
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        await self.process_request(
            scope=scope, receive=receive, send=send, routes=routes
        )
    ...
    async def process_request(
        self, scope: Scope, receive: Receive, send: Send, routes: Sequence[BaseRoute]
    ) -> None:
