...
class JSONField(sqlalchemy.types.TypeDecorator):  # type: ignore[type-arg]  # pylint: disable=abstract-method
    ...
    def __init__(  # pylint: disable=keyword-arg-before-vararg
        ...
        | typing.Any = json,  # pylint: disable=redefined-outer-name
        json_type: TypeEngine[typing.Any]
        | type[TypeEngine[typing.Any]] = sqlalchemy.JSON,
        *args: typing.Any,
        **kwargs: typing.Any,
    ) -> None:
        """JSONField.
    ...
    def process_bind_param(
        self, value: typing.Any, dialect: Dialect
    ) -> str | typing.Any:
    ...
    def process_result_value(
        self, value: str | typing.Any, dialect: Dialect
    ) -> typing.Any:
