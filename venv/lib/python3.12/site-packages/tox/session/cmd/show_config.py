...
def print_key_value(
    is_colored: bool, key: str, value: str, multi_line: bool = False
...
def print_conf(
    is_colored: bool, conf: ConfigSet, keys: Iterable[str]
) -> None:  # noqa: FBT001
    for key in keys or conf:
        ...
        try:
            ...
            as_str, multi_line = (
                _colored(is_colored, Fore.LIGHTRED_EX, f"# Exception: {exception!r}"),
                False,
            )
        if multi_line and "\n" not in as_str:
            multi_line = False
