...
class CovController:
    ...
    def __init__(
        ...
        config: Union[None, object],
        nodeid: Union[None, str],
    ):
    ...
    def set_env(self):
        ...
        os.environ["COV_CORE_DATAFILE"] = os.path.abspath(
            self.cov.config.data_file
        )  # noqa: PTH100
        if self.cov_branch:
    ...
    def get_node_desc(platform, version_info):
        ...
        return "platform {}, python {}".format(
            platform, "{}.{}.{}-{}-{}".format(*version_info[:5])
        )
    ...
    def summary(self, stream):
        ...
        if "annotate" in self.cov_report:
            ...
            if annotate_dir:
                stream.write(
                    f"Coverage annotated source written to dir {annotate_dir}\n"
                )
            else:
