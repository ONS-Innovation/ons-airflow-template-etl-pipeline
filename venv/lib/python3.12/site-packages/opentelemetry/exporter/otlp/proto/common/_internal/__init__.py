...
def _encode_value(value: Any, allow_null: bool = False) -> Optional[PB2AnyValue]:
...
def _encode_key_value(key: str, value: Any, allow_null: bool = False) -> PB2KeyValue:
    return PB2KeyValue(key=key, value=_encode_value(value, allow_null=allow_null))
...
def _encode_array(
    ...
    return [
        _encode_value(v, allow_null=allow_null) if v is not None
