...
from typing import (TYPE_CHECKING, Any, Collection, Iterable, Mapping,
                    MutableMapping, MutableSet, Optional, Type, TypeVar, cast)

from libcst._batched_visitor import (BatchableCSTVisitor, VisitorMethod,
                                     visit_batched)
...
if TYPE_CHECKING:
    ...
    from libcst.metadata.base_provider import (  # noqa: F401
        BaseMetadataProvider, ProviderT)
