...
class lifespan:  # noqa: N801
    ...
    _lifespan: (
        ...
        | Callable[[Starlette, svcs.Registry], AsyncGenerator[dict[str, object], None]]
    ...
    async def __call__(self, app: Starlette) -> AsyncGenerator[dict[str, object], None]:
        cm: Callable[[Starlette, svcs.Registry], contextlib.AbstractAsyncContextManager]
