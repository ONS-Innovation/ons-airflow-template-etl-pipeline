...
class lifespan:  # noqa: N801
    ...
    _lifespan: (
        ...
        | Callable[[FastAPI, svcs.Registry], AsyncGenerator[dict[str, object], None]]
    ...
    async def __call__(self, app: FastAPI) -> AsyncGenerator[dict[str, object], None]:
        cm: Callable[[FastAPI, svcs.Registry], contextlib.AbstractAsyncContextManager]
