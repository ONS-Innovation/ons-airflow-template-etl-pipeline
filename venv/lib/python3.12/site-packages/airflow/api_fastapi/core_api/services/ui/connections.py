...
class HookMetaService:
    ...
    def _get_hooks_with_mocked_fab() -> (
        tuple[
            MutableMapping[str, HookInfo | None],
            dict[str, ConnectionFormWidgetInfo],
            dict[str, dict],
        ]
    ):
        ...
        with contextlib.ExitStack() as stack:
            try:
                ...
                stack.enter_context(
                    mock.patch(
                        "wtforms.fields.StringField", HookMetaService.MockStringField
                    )
                )
                stack.enter_context(
                    mock.patch(
                ...
                stack.enter_context(
                    mock.patch(
                        "wtforms.fields.IntegerField", HookMetaService.MockIntegerField
                    )
                )
                stack.enter_context(
                    mock.patch(
                        "wtforms.PasswordField", HookMetaService.MockPasswordField
                    )
                )
                stack.enter_context(
                ...
                stack.enter_context(
                    mock.patch(
                        "wtforms.fields.BooleanField", HookMetaService.MockBooleanField
                    )
                )
                stack.enter_context(
                    mock.patch(
                        "wtforms.fields.simple.BooleanField",
                        HookMetaService.MockBooleanField,
                    )
                )
                stack.enter_context(
                    mock.patch(
                        "wtforms.validators.Optional", HookMetaService.MockOptional
                    )
                )
                stack.enter_context(
    ...
    def _make_standard_fields(
        ...
        def make_field(
            field_name: str, field_behaviour: dict
    ...
    @staticmethod
    def _convert_extra_fields(
        form_widgets: dict[str, ConnectionFormWidgetInfo]
