...
def _dfs_connected_components(
    ...
    for adj_node_id in adjacency_matrix[node_id]:
        if not visited[adj_node_id]:
            temp = _dfs_connected_components(
                temp, adj_node_id, visited, adjacency_matrix
            )
    ...
    for node_id in adjacency_matrix:
        if visited[node_id] is False:
            ...
            connected_components.append(
                _dfs_connected_components(temp, node_id, visited, adjacency_matrix)
            )
...
def extract_single_connected_component(
    ...
    edges = [
        ...
        for edge in edges
        if (
            edge["source_id"] in connected_component
            and edge["target_id"] in connected_component
        )
    ]
