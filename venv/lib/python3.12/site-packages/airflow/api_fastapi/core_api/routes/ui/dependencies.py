...
def get_dependencies(
    session: SessionDep, node_id: str | None = None
) -> BaseGraphResponse:
    """Dependencies graph."""
    ...
    edges = [
        ...
        for source, target in sorted(edge_tuples)
    ]
    ...
    if node_id is not None:
        try:
            data = extract_single_connected_component(
                node_id, data["nodes"], data["edges"]
            )
