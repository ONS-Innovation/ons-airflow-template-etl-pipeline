...
def structure_data(
    ...
    if external_dependencies:
        ...
        for dependency_dag_id, dependencies in sorted(
            ...
            for dependency in dependencies:
                ...
                if (
                    dependency.target != dependency.dependency_type
                ...
                # start dependency
                if (
                    dependency.source == dependency.dependency_type
                    or dependency.target == dag_id
                ) and entry_node_ref:
                    start_edges.append(
                        {
