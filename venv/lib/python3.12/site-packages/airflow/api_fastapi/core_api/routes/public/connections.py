...
@connections_router.delete(
    ...
    dependencies=[
        Depends(requires_access_connection(method="DELETE")),
...
@connections_router.patch(
    "",
    dependencies=[
        Depends(requires_access_connection(method="PUT")),
        Depends(action_logging()),
    ],
)
...
def patch_connection(
    ...
    connection: Connection = session.scalar(
...
@connections_router.post(
    "/test", dependencies=[Depends(requires_access_connection(method="POST"))]
)
def test_connection(
