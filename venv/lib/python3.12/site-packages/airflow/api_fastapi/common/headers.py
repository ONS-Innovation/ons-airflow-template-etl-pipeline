...
HeaderAcceptJsonOrText = Annotated[
    Mimetype, Depends(header_accept_json_or_text_depends)
]
...
HeaderAcceptJsonOrNdjson = Annotated[
    Mimetype, Depends(header_accept_json_or_ndjson_depends)
]
