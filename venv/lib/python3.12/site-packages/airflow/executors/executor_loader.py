...
class ExecutorLoader:
    ...
    def _get_executor_names(cls) -> list[ExecutorName]:
        ...
        for team_id, executor_names_config in all_executor_names:
            ...
            unique_modules = set(
                [exec_name.module_path for exec_name in executor_names_per_team]
            )
        ...
        if team_config:
            ...
            for team in team_config.split(","):
                ...
                configs.append(
                    (
                        team_id,
                        conf.get_mandatory_list_value(
                            "core", "executor", team_id=team_id
                        ),
                    )
                )
        return configs
    ...
    def init_executors(cls) -> list[BaseExecutor]:
        ...
        for executor_name in executor_names:
            ...
            if executor_name.alias:
                ...
                cls.executors[
                    loaded_executor.__class__.__name__
    ...
    def lookup_executor_name_by_str(cls, executor_name_str: str) -> ExecutorName:
        ...
        if (
            not _classname_to_executors
            or not _module_to_executors
            or not _alias_to_executors
        ):
    ...
    def import_executor_cls(
        cls, executor_name: ExecutorName
