...
def _validate_asset_function_arguments(f: Callable) -> None:
    for name, param in inspect.signature(f).parameters.items():
        ...
        if (
            ...
            raise TypeError(
                f"positional-only argument '{name}' without a default is not supported in @asset"
            )


class _AssetMainOperator(PythonOperator):
    def __init__(
        self, *, definition_name: str, uri: str | None = None, **kwargs
    ) -> None:
    ...
    @classmethod
    def from_definition(
        cls, definition: AssetDefinition | MultiAssetDefinition
    ) -> Self:
        ...
        return cls(
            ...
            inlets=[
                ...
                for inlet_asset_name, param in inspect.signature(
