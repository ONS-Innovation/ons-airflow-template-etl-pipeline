...
def _(
    xcom_arg: PlainXComArg, resolved_val: Sized, upstream_map_indexes: dict[str, int]
):
...
def _(xcom_arg: ZipXComArg, resolved_val: Sized, upstream_map_indexes: dict[str, int]):
    all_lengths = (
        get_task_map_length(arg, resolved_val, upstream_map_indexes)
...
@get_task_map_length.register
def _(
    xcom_arg: ConcatXComArg, resolved_val: Sized, upstream_map_indexes: dict[str, int]
):
    all_lengths = (
        get_task_map_length(arg, resolved_val, upstream_map_indexes)
        for arg in xcom_arg.args
