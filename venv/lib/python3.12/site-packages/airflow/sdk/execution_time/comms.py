...
from airflow.sdk.api.datamodels._generated import (
    ...
    AssetResponse, BundleInfo, ConnectionResponse, DagRunStateResponse,
...
class AssetResult(AssetResponse):
    ...
    def from_asset_response(cls, asset_response: AssetResponse) -> AssetResult:
        ...
        return cls(
            **asset_response.model_dump(exclude_defaults=True), type="AssetResult"
        )
...
class AssetEventResult(AssetEventResponse):
    ...
    @classmethod
    def from_asset_event_response(
        cls, asset_event_response: AssetEventResponse
    ) -> AssetEventResult:
...
class AssetEventsResult(AssetEventsResponse):
    ...
    @classmethod
    def from_asset_events_response(
        cls, asset_events_response: AssetEventsResponse
    ) -> AssetEventsResult:
        """
    ...
    def iter_asset_event_results(self) -> Iterator[AssetEventResult]:
        return (
            AssetEventResult.from_asset_event_response(event)
            for event in self.asset_events
        )
...
class InactiveAssetsResult(InactiveAssetsResponse):
    ...
    def from_inactive_assets_response(
        ...
        """
        return cls(
            **inactive_assets_response.model_dump(exclude_defaults=True),
...
class XComSequenceIndexResult(BaseModel):
    ...
    @classmethod
    def from_response(
        cls, response: XComSequenceIndexResponse
...
class XComSequenceSliceResult(BaseModel):
    ...
    @classmethod
    def from_response(
        cls, response: XComSequenceSliceResponse
...
class ConnectionResult(ConnectionResponse):
    ...
    @classmethod
    def from_conn_response(
        cls, connection_response: ConnectionResponse
    ) -> ConnectionResult:
        """
        ...
        # to avoid sending unset fields (which are defaults in our case).
        return cls(
            **connection_response.model_dump(exclude_defaults=True, by_alias=True),
...
class VariableResult(VariableResponse):
    ...
    @classmethod
    def from_variable_response(
        cls, variable_response: VariableResponse
    ) -> VariableResult:
        """
        ...
        """
        return cls(
            **variable_response.model_dump(exclude_defaults=True), type="VariableResult"
        )
...
class DagRunStateResult(DagRunStateResponse):
    ...
    def from_api_response(
        cls, dr_state_response: DagRunStateResponse
    ) -> DagRunStateResult:
        """
        ...
        """
        return cls(
            **dr_state_response.model_dump(exclude_defaults=True),
...
class PrevSuccessfulDagRunResult(PrevSuccessfulDagRunResponse):
    ...
    @classmethod
    def from_dagrun_response(
        cls, prev_dag_run: PrevSuccessfulDagRunResponse
        ...
        """
        return cls(
            **prev_dag_run.model_dump(exclude_defaults=True),
...
class TaskStatesResult(TaskStatesResponse):
    ...
    @classmethod
    def from_api_response(
        cls, task_states_response: TaskStatesResponse
    ) -> TaskStatesResult:
        """
        Create result class from API Response.
        ...
        """
        return cls(
            **task_states_response.model_dump(exclude_defaults=True),
