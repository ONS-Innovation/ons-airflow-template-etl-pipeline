    ...
    def partial(
        ...
        **kwargs,
        ...
        partial_kwargs.update(
            ...
            and k in BaseOperator.__init__._BaseOperatorMeta__param_names
        )

        # Fill fields not provided by the user with default values.
        partial_kwargs.update(
            (k, v) for k, v in _PARTIAL_DEFAULTS.items() if k not in partial_kwargs
        )
        ...
        partial_kwargs["retry_delay"] = BaseOperator._convert_retry_delay(
        ...
        for k in ("execute", "failure", "success", "retry", "skipped"):
            partial_kwargs[attr] = _collect_callbacks(
...
class ExecutorSafeguard:
    ...
    tracker: ClassVar[ContextVar[BaseOperator]] = ContextVar(
        "ExecutorSafeguard_sentinel"
    )
...
class BaseOperator(AbstractOperator, metaclass=BaseOperatorMeta):
    ...
    _log_config_logger_name: str | None = field(
        default="airflow.task.operators", init=False
    )
    ...
    def __init__(
        ...
        *,
        ...
        on_execute_callback: None
        | TaskStateChangeCallback
        | Collection[TaskStateChangeCallback] = None,
        on_failure_callback: None
        | TaskStateChangeCallback
        ...
        **kwargs: Any,
        ...
        if execution_timeout is not None and not isinstance(
    ...
    def __deepcopy__(self, memo: dict[int, Any]):
        ...
        shallow_copy = (
            tuple(cls.shallow_copy_attrs) + cls._base_operator_shallow_copy_attrs
        )
    ...
    def resume_execution(
        ...
        if next_method == TRIGGER_FAIL_REPR:
            ...
            if (
                error := next_kwargs.get("error", "Unknown")
