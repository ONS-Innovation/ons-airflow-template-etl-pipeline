...
class ContinuousTimetable(_TrivialTimetable):
    ...
    active_runs_limit = (
        1  # Continuous DAGRuns should be constrained to one run at a time
    )
...
class AssetTriggeredTimetable(_TrivialTimetable):
    ...
    def generate_run_id(
        ...
        **extra,
        ...
        return DagRun.generate_run_id(
            run_type=run_type, logical_date=logical_date, run_after=run_after
        )
