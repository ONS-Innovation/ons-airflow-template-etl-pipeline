...
def upgrade():
    ...
    if dialect == "sqlite":
        ...
        op.execute(
            "INSERT INTO new_table SELECT * FROM dag_schedule_dataset_alias_reference"
        )
    ...
    if dialect == "mysql":
        ...
        mysql_drop_foreignkey_if_exists(
            "dsdar_dag_fkey", "dag_schedule_dataset_alias_reference", op
        )
...
def downgrade():
    ...
    if dialect == "mysql":
        ...
        mysql_drop_foreignkey_if_exists(
            "dsdar_dag_id_fkey", "dag_schedule_dataset_alias_reference", op
        )
        mysql_create_foreignkey_if_not_exists(
            "dsdar_dataset_fkey",
            "dag_schedule_dataset_alias_reference",
