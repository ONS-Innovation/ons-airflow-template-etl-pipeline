...
def upgrade():
    ...
    op.execute(
        "update dag_run set run_type = 'asset_triggered' where run_type = 'dataset_triggered'"
    )
...
def downgrade():
    ...
    op.execute(
        "update dag_run set run_type = 'dataset_triggered' where run_type = 'asset_triggered'"
    )
