...
def upgrade():
    ...
    with op.batch_alter_table("dag", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("bundle_name", sa.String(length=250), nullable=True)
        )
        batch_op.add_column(
            sa.Column("bundle_version", sa.String(length=200), nullable=True)
        )
    ...
    with op.batch_alter_table("dag_run", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("bundle_version", sa.String(length=250), nullable=True)
        )
