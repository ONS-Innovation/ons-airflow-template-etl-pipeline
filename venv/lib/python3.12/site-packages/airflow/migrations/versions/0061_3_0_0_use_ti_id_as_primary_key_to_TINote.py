...
def upgrade():
    ...
    with op.batch_alter_table("task_instance_note", schema=None) as batch_op:
        batch_op.alter_column(
            "ti_id",
            existing_type=sa.String(length=36).with_variant(
...
def downgrade():
    ...
    with op.batch_alter_table("task_instance_note", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                "map_index", sa.Integer(), nullable=True, server_default=sa.text("-1")
            )
        )
    ...
    with op.batch_alter_table("task_instance_note", schema=None) as batch_op:
        ...
        batch_op.create_primary_key(
            "task_instance_note_pkey", ["dag_id", "task_id", "run_id", "map_index"]
        )
