...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "dag_id", "version_number", name="dag_id_v_name_v_number_unique_constraint"
        ),
    )
    with op.batch_alter_table("dag_code") as batch_op:
        ...
        batch_op.add_column(
            sa.Column("dag_version_id", UUIDType(binary=False), nullable=False)
        )
        batch_op.add_column(
            sa.Column("source_code_hash", sa.String(length=32), nullable=False)
        )
        batch_op.add_column(sa.Column("dag_id", StringID(), nullable=False))
        batch_op.add_column(
            sa.Column(
                "created_at", TIMESTAMP(), default=timezone.utcnow, nullable=False
            )
        )
        ...
        batch_op.create_unique_constraint(
            "dag_code_dag_version_id_uq", ["dag_version_id"]
        )
    ...
    with op.batch_alter_table("serialized_dag") as batch_op:
        ...
        batch_op.create_unique_constraint(
            "serialized_dag_dag_version_id_uq", ["dag_version_id"]
        )
    ...
    with op.batch_alter_table("dag_run", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("created_dag_version_id", UUIDType(binary=False), nullable=True)
        )
        batch_op.create_foreign_key(
...
def downgrade():
    ...
    with op.batch_alter_table("task_instance", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("task_instance_dag_version_id_fkey"), type_="foreignkey"
        )
    ...
    with op.batch_alter_table("dag_run", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "dag_hash", sa.String(length=32), autoincrement=False, nullable=True
            )
        )
    ...
    with op.batch_alter_table("dag_code", schema=None) as batch_op:
        batch_op.drop_constraint("dag_code_pkey", type_="primary")
        batch_op.drop_constraint(
            batch_op.f("dag_code_dag_version_id_fkey"), type_="foreignkey"
        )
    ...
    with op.batch_alter_table(
        "serialized_dag", schema=None, naming_convention=naming_convention
    ) as batch_op:
        batch_op.drop_column("id")
        batch_op.drop_constraint(
            batch_op.f("serialized_dag_dag_version_id_fkey"), type_="foreignkey"
        )
        batch_op.drop_column("created_at")
        batch_op.drop_column("dag_version_id")
        batch_op.add_column(
