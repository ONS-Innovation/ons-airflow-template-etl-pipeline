...
class OtelTrace:
    ...
    def get_otel_tracer_provider(
        ...
        if debug is True:
            ...
            if self.use_simple_processor:
                ...
                span_processor_for_tracer_prov: SpanProcessor = SimpleSpanProcessor(
                    ConsoleSpanExporter()
                )
            else:
                log.info("[BatchSpanProcessor] is being used")
                span_processor_for_tracer_prov = BatchSpanProcessor(
                    ConsoleSpanExporter()
                )
        else:
    ...
    def start_span(
        ...
        tracer = self.get_tracer(
            component=component, trace_id=trace_id, span_id=span_id
        )
    ...
    def _new_span(
        ...
        if start_as_current:
            ...
            current_span_ctx = trace.set_span_in_context(
