...
from airflow.exceptions import (AirflowException, AirflowSkipException,
                                DagNotFound, DagRunAlreadyExists)
    ...
    def get_link(self, operator: BaseOperator, *, ti_key: TaskInstanceKey) -> str:
        ...
        if AIRFLOW_V_3_0_PLUS:
            ...
            return build_airflow_dagrun_url(
                dag_id=trigger_dag_id, run_id=triggered_dag_run_id
            )
...
class TriggerDagRunOperator(BaseOperator):
    ...
    def execute(self, context: Context):
        ...
        elif self.logical_date is None or isinstance(
            self.logical_date, datetime.datetime
        ):
        ...
        if AIRFLOW_V_3_0_PLUS:
            self._trigger_dag_af_3(
                context=context, run_id=run_id, parsed_logical_date=parsed_logical_date
            )
        else:
